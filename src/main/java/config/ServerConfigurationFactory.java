...
public class ServerConfigurationFactory {
    ...
    /**
     * Create configuration for cache "ReservationsCache".
     * 
     * @return Configured cache.
     * @throws Exception if failed to create cache configuration.
     **/
    public static CacheConfiguration cacheReservationsCache() throws Exception {
        CacheConfiguration ccfg = new CacheConfiguration();

        ccfg.setName("ReservationsCache");
        ccfg.setCacheMode(CacheMode.PARTITIONED);
        ccfg.setAtomicityMode(CacheAtomicityMode.ATOMIC);
        ...
        cacheStoreFactory.setTypes(jdbcTypeReservations(ccfg.getName()));
        ...
        fields.put("customerId", "java.lang.String");
        fields.put("flightId", "java.lang.String");
        fields.put("seat", "java.lang.String");
        fields.put("reservationId", "java.lang.String");

        qryEntity.setFields(fields);

        HashMap<String, String> aliases = new HashMap<>();

        aliases.put("reservationId", "reservation_id");
        aliases.put("customerId", "customer_id");
        aliases.put("flightId", "flight_id");
    ...
    /**
     * Create JDBC type for "jdbcTypeReservations".
     * 
     * @param cacheName Cache name.
     * @return Configured JDBC type.
     **/
    private static JdbcType jdbcTypeReservations(String cacheName) {
        JdbcType type = new JdbcType();
        ...
        type.setKeyFields(new JdbcTypeField(Types.VARCHAR, "reservation_id", String.class, "reservationId"));

        type.setValueFields(
            new JdbcTypeField(Types.VARCHAR, "customer_id", String.class, "customerId"),
            new JdbcTypeField(Types.VARCHAR, "flight_id", String.class, "flightId"),
            new JdbcTypeField(Types.VARCHAR, "seat", String.class, "seat")
        );
